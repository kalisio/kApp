<template>
  <template v-for="key in ['size', 'radius', 'custom']" :key="key">
    <ComponentCard :title="$t('Shapes.LABEL') + ' - ' + key" class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
      <div class="column full-height full-width justify-between no-wrap q-gutter-y-md">
        <template v-for="shape in shapes[key]" :key="shape.shape">
          <div class="row text-center">
            <div class="col">{{ shape.name }}</div>
            <div class="col-auto">
...
Shapes.add('pin-with-empty-star', {
  viewBox: [0, 0, 14, 24],
...
Shapes.add('full-circle', {
  viewBox: [0, 0, 24, 24],
  content: '<circle class="cls-1" cx="12" cy="12" r="12"/>'
})
Shapes.add('empty-circle', {
  viewBox: [0, 0, 24, 24],
...
Shapes.add('full-circle-with-empty-star', {
  viewBox: [0, 0, 24, 24],
...
Shapes.add('full-rounded-square-with-empty-star', {
  viewBox: [0, 0, 24, 24],
...
Shapes.add('full-rounded-square', {
  viewBox: [0, 0, 24, 24],
